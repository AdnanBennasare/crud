...
<div class="mx-auto mt-5 mb-5" style="width: 50%;">
<!-------------------------------- form ---------------------------------->
...
<br>
<label>date</label>
<input type="date" name="date" min="0" placeholder="date" value="" class="form-control">
</label>
<br>
...
<button type="submit" class="btn btn-primary" name="addanonce">Add announce</button>
